...
public class Problem11 extends Problem {
	...
	class Position {
		...
		public boolean exists(int[][] a) {
			return y >= 0 && y < a.length  && x >= 0 && x < a[y].length ;
		}
	...
	class Step {
		...
		Position step(Position a) {
			return new Position(a.x + dx, a.y + dy);
		}
	}
	...
	public void solve() {
		...
		Step left = new Step(1, 0);
		Step down = new Step(0, 1);
		Step leftdiag = new Step(1, 1);
		Step rightdiag = new Step(-1, 1);
		...
		System.out.println(this + ": max product " + max);
	}
}
